...
export default function EditJob() {
            ...
            try {
                ...
                if (docSnap.exists()) {
                    ...
                    setFormData({ 
                        ...
                        showFormFillingHelp: data.showFormFillingHelp !== false
                    });
                } else {
    ...
    const handleAddSidebarLink = () => {
        setFormData((prev: any) => ({
            ...prev,
            sidebarLinks: [...(prev.sidebarLinks || []), { title: "", url: "" }]
        }));
    };

    const handleRemoveSidebarLink = (idx: number) => {
        const newLinks = formData.sidebarLinks.filter((_: any, i: number) => i !== idx);
        setFormData((prev: any) => ({ ...prev, sidebarLinks: newLinks }));
    };
        ...
        <div className="max-w-4xl mx-auto pb-20">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <section className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-6">
                    ...
                    <div className="space-y-4">
                        {formData.sidebarLinks?.map((link: any, idx: number) => (
                            <div key={idx} className="flex flex-col md:flex-row gap-4 p-4 border rounded-xl bg-gray-50 relative group">
                                <div className="absolute -left-3 top-1/2 -translate-y-1/2 flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition-opacity z-10">
                                    <button
                                        type="button"
                        ...
                        {(!formData.sidebarLinks || formData.sidebarLinks.length === 0) && (
                        ...
                        <div className="md:col-span-2 flex items-center justify-between mt-2 p-4 bg-white rounded-lg border border-green-200 shadow-sm">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input 
                                    ...
                                    onChange={(e) => setFormData((prev: any) => ({ ...prev, showFormFillingHelp: e.target.checked }))}
                                />
